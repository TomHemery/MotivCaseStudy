...
namespace MotivWebApp.Source.Products
{
    ...
    {
        private readonly List<FinanceProduct> _products;
        private readonly Random _random;
        
        public ProductRegistry()
        {
            _products = new List<FinanceProduct>{
        ...
        {
            return _products.Where(plan => plan.minimumScore <= score).ToList();
        }

        public FinanceProduct GetRandomProduct()
        {
            return _products[_random.Next(_products.Count)];
        }
